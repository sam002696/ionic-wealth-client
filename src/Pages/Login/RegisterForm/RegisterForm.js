                                ...
                                <div class="hero-content w-full min-vh-100 flex flex-col">
                                    ...
                                    <div class="flex flex-wrap my-auto">
                                        <div class="col-lg-9 mx-auto">
                                            ...
                                            <p class="text-4 text-white mb-5">Sign up with your email and personal details to get started!</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row-register">
                                    <div className="register-form-wrapper col-form mx-auto my-auto">
                                        <h3 className="uppercase text-2xl mb-4 text-center">
                                            <span className="font-semibold text-indigo-500">REGISTER</span> Now
                                        </h3>
                                        <form
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                <div className='flex relative items-center justify-items-center'>
                                                    ...
                                                    />
                                                    <i className={`${passwordShown ? 'fa fa-solid fa-eye ' : 'fa fa-solid fa-eye-slash text-gray-400'
                                                        } absolute right-0 mr-1`} onClick={togglePasswordVisiblity} />
                                                </div>

                                                <p className="text-my-sm leading-normal text-gray-400 mt-2">
                                                    <b>Password requirement:</b> Minimum eight characters, at least one letter, one number and one special character.
                                                </p>
                                            </div>
                                            <div>
                                                <label className="block mb-1 tracking-normal">
						...
						<option value="female">Female</option>
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <label className="block tracking-normal leading-none">
                                                    Agree to the <Link to="/terms-conditions" className="text-blue-600 hover:text-blue-700">Terms and Conditions</Link> {requiredMark}
                                                </label>
                                            </div>
                                            <div>
                                                {(errors.displayName ||
                                        ...
                                        <div className="hints text-my-sm leading-relaxed text-gray-700 mt-3">
                                            <span className="font-semibold tracking-wider">Already Registered ? </span>
                                            <Link to="/login"><span className="font-semibold tracking-wide text-lg underline text-blue-600 hover:text-blue-600">Login</span></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
