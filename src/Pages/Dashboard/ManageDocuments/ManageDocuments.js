...
const ManageDocuments = () => {
    ...
    useEffect(() => {
        setLoading(true);
        axios.get('https://arcane-earth-23317.herokuapp.com/documents', {
            headers: {
            ...
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                <form className='mb-5 w-3/5'>
                    ...
                    <div class="relative">
                        ...
                        <input type="search" id="default-search" class="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 outline-none" placeholder="Search by id or client name" onChange={(event) => {
                    ...
                    </thead>
                    {
                        loading ? <LoadingStatus status={status} /> :
                            documents.filter((val) => {
                                ...
                                <ManageDocumentItem key={document._id} document={document} documents={documents} setDocuments={setDocuments} />
                            )
                    }
                </table>
            </div>
