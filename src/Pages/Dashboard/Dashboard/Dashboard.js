            ...
            <div className="dashboard-wrapper min-h-vh-100 flex flex-nowrap ">
                <div className="dashboard-sidebar dashboard-sidebar-bg-clr  flex-shrink-0 shadow-my-around py-4 lg:py-8 px-2 lg:px-4 xl:px-6" >
                    <div className="logo-wrapper flex-shrink-0 justify-items-center hidden md:block ">
                        <Link to="/home">
                            <img src={logos} alt="Agency logo" className="w-40  mx-1 mb-36" />
                        </Link>
                    </div>
                    <div className=''>
                                ...
                                <>
                                    ...
                                    <li className="border-t">
                                        ...
                                        >
                                            ...
                                            <span className="hidden md:block pl-3">Client Agreement</span>
                                        </NavLink>
                                    </li>
                                    <li className="border-t">
                                        <NavLink
                                    ...
                                    <li className="border-t">
                                        ...
                                        >
                                            ...
                                            <span className="hidden md:block pl-3">Risk Profiler</span>
                                        </NavLink>
                                    </li>
                ...
                // }}
                >
                    <header className="dashboard-header navbar static mb-8">
