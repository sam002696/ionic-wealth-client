...
import logo from '../../../images/Ionic-Wealth-Logo-1000px-LIGHT.png'
import { NavLink, useRouteMatch, Switch } from 'react-router-dom';
import Footer from '../../Shared/Footer/Footer';
import dbBg from '../../../images/Dashboard-bg.jpg';
            ...
            <header className="dashboard-header navbar static bg-slate-50 shadow-xl">
                <div className="px-4 w-full flex items-center justify-between">
                    <div className="logo-wrapper flex-shrink-0 w-28 md:w-36">
                        <Link to="/home">
                            <img src={logo} alt="Ionic Wealth" className="w-full" />
                        </Link>
                    </div>
                    ...
                    <div className="lg:container m-0 lg:m-0 p-0 lg:p-0">
                        <Switch>
                            ...
                            <>
                                ...
                                <AdminRoute path={`${path}/manage-documents`}>
                                    <ManageDocuments />
                                </AdminRoute>
                            </>
