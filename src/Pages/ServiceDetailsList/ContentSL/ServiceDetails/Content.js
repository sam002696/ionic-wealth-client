...
import servicebanner from '../../../../images/service-01.jpg'
import servicesmallbanner from '../../../../images/service-02.jpg'
    ...
    return (
        <>
            ...
            <div className="service-details-content">
                ...
                <h2 className="title dark:text-white">Financial Planning</h2>
                ...
                <div className="row-servicedetails justify-items-center mt-10">
                    ...
                    <div className="col-lg-6-servicedetails mt-10">
                        <h3 className="sub-title dark:text-white">How To Buildup Buisness</h3>
                        <p>
                        ...
                        <ul className="check-list mt-30 ">
                            <li className='dark:service-details-lits'><i className="fas fa-check " />Business &amp; Consulting Agency</li>
                            <li className='dark:service-details-lits'><i className="fas fa-check" />Awards Winning Business Comapny</li>
                            <li className='dark:service-details-lits'><i className="fas fa-check" />Complete Guide To Mechanical</li>
                            <li className='dark:service-details-lits'><i className="fas fa-check" />Firebase Authentication &amp; Database</li>
                        </ul>
                    </div>
                </div>

                <div className="w-full mt-10 mx-auto bg-white rounded-2xl">
                    <Disclosure>
                        {({ open }) => (
                            <>
