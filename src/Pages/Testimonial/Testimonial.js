...
const Testimonial = () => {
    const url = "https://newsapi.org/v2/top-headlines?sources=google-news-uk&apiKey=146c224ec0614ff9bda74183f2e56bf8";
    ...
    return (
        <>
            ...
            <section id="main-testimonial" className='main-testimonial  dark:bg-dark-variant'>
                                                        ...
                                                        <cite title="Source Title">
                                                            <a href="google.com" className="alignleft">
                                                                <span data-picture data-alt="image description">
                                                                    <span data-src="http://placehold.it/58x54" data-width="58" data-height="54"></span>
                                                                    <span data-src="http://placehold.it/58x54" data-width="58" data-height="54" data-media="(-webkit-min-device-pixel-ratio:1.5), (min-resolution:1.5dppx)" ></span>
